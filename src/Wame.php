...
class Wame
{
    ...
    /**
     * @param array $data server, key and optional provider
     *   ('whatsapp' | 'instagram' | 'messenger'), applied as the default
     *   provider on every send unless overridden per-call.
     */
    public function __construct(array $data = [])
    {
        ...
        $this->message = new Message($this->http, $provider);
